...
const DonutChart = ({ collected, total }) => {
  ...
  return (
    <svg width="140" height="140" viewBox="0 0 140 140">
      ...
      />
      <text x="70" y="66" textAnchor="middle" fontSize="22" fontWeight="bold" fill="#111827">
        {Math.round(pct * 100)}%
      </text>
...
const InicioScreen = () => {
  ...
  for (const c of stats.byCountry) {
    ...
    const grupo  = sel ? `Grupo ${sel.grupo}` : 'Otro';
  ...
  return (
    <div className="p-4 space-y-4">
      <h1 className="text-xl font-bold text-gray-800">Mi Colección</h1>
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-4 space-y-5">
        <h2 className="text-xs font-semibold text-gray-500 uppercase tracking-wider">Por selección</h2>
        {grupos.map(grupo => (
